...
import type { IProjectTaskChatMessage } from "@/types/project.type";
import { formatDistanceToNow } from "date-fns";

interface ChatMessageItemProps {
  message: IProjectTaskChatMessage;
...
export function ChatMessageItem({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`flex items-center gap-2 px-1 ${isCurrentUser ? "flex-row-reverse" : "flex-row"}`}
        >
