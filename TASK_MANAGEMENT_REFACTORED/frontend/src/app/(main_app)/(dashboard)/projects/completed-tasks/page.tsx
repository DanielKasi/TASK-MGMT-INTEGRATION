...
export default function CompletedTasksPage() {
  const [tasks, setTasks] = useState<IProjectCompletedTasks[]>([]);
  ...
  const [taskToDelete, setTaskToDelete] =
    useState<IProjectCompletedTasks | null>(null);
  ...
  const fetchFirstPage = useCallback(async () => {
    ...
    try {
      ...
      const res =
        await PROJECT_TASKS_STATUSES_API.getPaginatedProjectCompletedTasks(
          params
        );
  ...
  const fetchNextPage = useCallback(async () => {
    ...
    try {
      const res =
        await PROJECT_TASKS_STATUSES_API.getPaginatedProjectCompletedTasksFromUrl(
          { url: nextUrl }
        );
